...
const DB = {
    suppliers: [
        ...
        { id: 5, name: "Concretos del Norte", rating: 4.7, reviews: 42, location: "Nuevo Chimbote", specialty: "Concreto Premezclado", certifications: ["ISO 9001"], products: [{ id: 501, name: "Mixer Concreto 210", price: 320.00, imageUrl: "https://placehold.co/300x300/e0e0e0/555?text=Concreto" }] },
        { id: 6, name: "Distribuidora Santa Rosa", rating: 4.2, reviews: 30, location: "Chimbote", specialty: "Acabados y Pinturas", certifications: ["Garantía"], products: [{ id: 601, name: "Balde Pintura Látex", price: 85.00, imageUrl: "https://placehold.co/300x300/e0e0e0/555?text=Pintura" }] }
    ],
    notifications: [
